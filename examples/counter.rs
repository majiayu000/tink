    ...
    Box::new()
        ...
        .child(
            Box::new()
                ...
                .child(Text::new("  j/Down: Decrement").dim().into_element())
                .child(Text::new("  k/Up:   Increment").dim().into_element())
                .child(Text::new("  r:      Reset").dim().into_element())
                .child(Text::new("  q:      Exit").dim().into_element())
                .into_element(),
        )
        .into_element()
}
